...
public class CustomSurfaceView extends GLSurfaceView {
    ...
    private gr.mobile.zisis.pibook.rendering.external.GLRenderer mRenderer;

    public enum TargetRenderingAPI{
        OPENGL_ES_2, OPENGL_ES_3
    }

    public CustomSurfaceView(final Context context, final gr.mobile.zisis.pibook.rendering.external.GLRenderer renderer, final TargetRenderingAPI... targetRenderingAPIs) {
        this(context, renderer, null, targetRenderingAPIs);
    }

    public CustomSurfaceView(final Context context, final gr.mobile.zisis.pibook.rendering.external.GLRenderer renderer, final AttributeSet attrs, final TargetRenderingAPI... targetRenderingAPIs) {
        super(context, attrs);
